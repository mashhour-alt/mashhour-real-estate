...
export const copy = {
  en: {
    ...
    allPrices: "Any price",
    priceUnder1m: "Under AED 1M",
    price5mPlus: "AED 5M+",
    allHandover: "Any handover",
    sortDefault: "Sort by",
    sortPriceAsc: "Price: low to high",
    sortPriceDesc: "Price: high to low",
    sortHandover: "Handover: soonest",
    projects: "Projects",
  ...
  ar: {
    ...
    allPrices: "أي سعر",
    priceUnder1m: "أقل من مليون",
    price5mPlus: "أكثر من 5 مليون",
    allHandover: "أي تسليم",
    sortDefault: "ترتيب حسب",
    sortPriceAsc: "السعر: من الأقل",
    sortPriceDesc: "السعر: من الأعلى",
    sortHandover: "التسليم: الأقرب",
    projects: "مشروع",
    developers: "مطور",
    areas: "مؤشر منطقة",
  ...
  it: {
    ...
    allPrices: "Qualsiasi prezzo",
    priceUnder1m: "Sotto 1M AED",
    price5mPlus: "Oltre 5M AED",
    allHandover: "Qualsiasi consegna",
    sortDefault: "Ordina per",
    sortPriceAsc: "Prezzo: crescente",
    sortPriceDesc: "Prezzo: decrescente",
    sortHandover: "Consegna: prima",
    projects: "Progetti",
